...
// class Control<B:Element, C:Element> extends InteractiveElement {
...
// 	@:writeonly @:alias public var inset:Float = background.margins;
...
// 	@:writeonly @:alias public var offset:Float = content.margins;
