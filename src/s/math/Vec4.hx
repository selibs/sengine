...
extern abstract Vec4(KhaVec4) from KhaVec4 to KhaVec4 {
	#if !macro
	@:to
	public inline function toIVec4():IVec4
		return IVec4.fromVec4(this);
	...
	public inline function log2():Vec4
		return @:privateAccess new Vec4(SMath.log2f(this.x), SMath.log2f(this.y), SMath.log2f(this.z), SMath.log2f(this.w));
	...
	public inline function sign():Vec4
		return new Vec4(this.x > 0 ? 1 : (this.x < 0 ? -1 : 0), this.y > 0 ? 1 : (this.y < 0 ? -1 : 0), this.z > 0 ? 1 : (this.z < 0 ? -1 : 0),
