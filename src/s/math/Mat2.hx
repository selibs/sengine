...
extern abstract Mat2(KhaMat2) from KhaMat2 to KhaMat2 {
	public static inline function empty():Mat2
		return KhaMat2.empty();

	public static inline function identity():Mat2
		return KhaMat2.identity();

	public static inline function scale(x:Float, y:Float):Mat2
		return KhaMat2.scale(x, y);

	public static inline function rotation(alpha:Float):Mat2
		return KhaMat2.rotation(alpha);
	...
	public inline function setFrom(v:Mat2) {
		this.setFrom(v);
		return this;
	}
